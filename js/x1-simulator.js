...
(function ($) {
    ...
    var $tvInterface = $('.tv-interface'),
        $challengeChooser = $('#challengeChooser'),
    ...
    function showChallengeText(challengeName) {
        $challengeChooser.hide();
        $challengeText.text(buttonSequence[challengeName].challengeText).show();
    }
    function resetChallenge() {
        $challengeText.hide();
        $challengeChooser.show();
        $tvInterface.find('img').hide();
    }
            ...
            if (evt.keyCode === buttonSequence[challengeName].steps[n]) {
                ...
                if (n === buttonSequence[challengeName].steps.length) {
                    window.setTimeout(function () {
                        //populate modal
                        populateBadgeModal(challengeName);
    ...
    function bindChallengeBtns() {
        ...
        $buttons.on('click', function () {
            ...
            showChallengeText(challengeName);
            challenge(challengeName);
        });
    }
    function bindEvents() {
        bindChallengeBtns();
        $winModal.find('.close-dialog').on('click', function () {
            resetChallenge();
        })
    }
    bindEvents();
